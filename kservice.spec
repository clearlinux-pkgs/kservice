...
%setup -q -n kservice-6.12.0
cd %{_builddir}/kservice-6.12.0
pushd ..
cp -a kservice-6.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742507523
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Service.so.6.12.0
/usr/lib64/libKF6Service.so.6
/usr/lib64/libKF6Service.so.6.12.0
